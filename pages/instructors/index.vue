<template>
    <div class="instructors">
        ...
        <section id="instructors_content">
            ...
            <div class="content">
                <div :id="`item_${key}`" class="wrapper" v-for="(data, key) in populateInstructors" :key="key" @mouseover.self="toggleActionHover(key)" @mouseleave.self="toggleActionLeave(key)">
