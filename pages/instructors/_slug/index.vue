  ...
  <transition name="fade">
    <div class="instructor_inner" v-if="loaded">
        ...
        <div class="content" v-if="!$store.state.isMobile">
          <div class="wrapper" v-for="(data, key) in scheduledDates" :key="key">
                  ...
                  <div class="info_icon">
                    ...
                    <transition name="slideAltY">
                      <div class="info_overlay" v-if="data.toggled">
                        ...
                        <span
                          v-html="
                            data.schedule.description != null
                              ? data.schedule.description
                              : data.schedule.class_type.description
                          "
                        ></span>
            ...
            <nuxt-link
              ...
              class="btn default_btn_out"
              v-else-if="data.hasUser && (data.originalHere || data.guestHere)"
            >
      ...
      <section id="comments">
        <div class="header">
          <h2>
            Here’s what other riders loved about {{ res.first_name }}'s class
          </h2>
          <div class="btn">
            <nuxt-link
              :to="`/instructors/${res.instructor_details.slug}/comment`"
              class="default_btn"
            >
              Write a Review
            </nuxt-link>
          ...
          >
            ...
            <div class="comment_info">
              <div class="comment_header">
                ...
                <div class="date">
                  {{ $moment(data.review_date).format('MMMM D, YYYY') }}
                </div>
              </div>
      ...
      <section id="ride_with">
        <div class="header">
          ...
          <a
            ...
            class="description"
          >
            <img src="/icons/lets-ride-ig-icon.svg" alt="lets-ride" />
            <span>@{{ res.instructor_details.instagram_name }}</span>
          </a>
        </div>
        <div class="content">
                ...
                me.$axios
                  ...
                  .then(res => {
                    if (res.data) {
                      ...
                      me.$axios
                        .post('api/schedules/validate', formData)
                        .then(res => {
                          if (res.data) {
                            setTimeout(() => {
      ...
      toggleOverlays(e) {
        ...
        me.scheduledDates.forEach((data, index) => {
          if (
            ...
            target.parentNode.previousElementSibling !== elements_first[index]
          ) {
            data.toggled = false
          }
        })
      ...
      async initial() {
        ...
        setTimeout(() => {
                ...
                if (!me.overallRatingComputed) {
                  if (me.overallRating < i) {
                    target.style.width = parseFloat(
                      `${100 * `0.${me.overallRating.split('.')[1]}`}%`
                    )
          ...
          me.$axios
            ...
            .then(({ data }) => {
              data.sort(
                (a, b) => parseFloat(b.countLikes) - parseFloat(a.countLikes)
              )
              me.feeds = data
            })
          me.loader(false)
