        ...
        <div class="instructor_inner" v-if="loaded">
            ...
            <section id="info">
                <div class="left">
                    <h1>
                        ...
                        <p v-if="res.instructor_details.position">
                            {{ res.instructor_details.position }}
                        </p>
                    </h1>
                    ...
                    <div
                        class="description"
                        v-html="res.instructor_details.description"
                    ></div>
                        ...
                        >
                            <g transform="translate(-1164.5 -208.5)">
                                <rect
                                    width="7"
                                    height="7"
                                    transform="translate(1165 209)"
                                    class="square"
                                />
                                <rect
                                    width="7"
                                    height="7"
                                    transform="translate(1165 219)"
                                    class="square"
                                />
                                <rect
                                    width="7"
                                    height="7"
                                    transform="translate(1175 209)"
                                    class="square"
                                />
                                <rect
                                    width="7"
                                    height="7"
                                    transform="translate(1175 219)"
                                    class="square_alt"
                                />
                            </g>
                        </svg>
            ...
            <section id="classes" v-if="scheduledDates.length > 0">
                ...
                <div class="content" v-if="!$store.state.isMobile">
                    <div
                        class="wrapper"
                        v-for="(data, key) in scheduledDates"
                        :key="key"
                    >
                        <div class="start">
                            <div class="date">
                                {{ parseDate('date', data.date) }}
                            </div>
                            <div class="time">
                        ...
                        <div class="info">
                            <img
                                class="main"
                                :src="getInstructorsImageInSchedule(data)"
                                :alt="res.instructor_details.images[0].alt"
                            />
                        ...
                        <nuxt-link
                            :to="`/book-a-bike/${data.id}`"
                            :event="''"
                            @click.native="checkIfNew(data, 'book', $event)"
                            class="btn default_btn_out"
                            v-if="
                                data.hasUser &&
                                    !data.isWaitlisted &&
                                    !data.isFull &&
                        ...
                        <div
                            @click="checkIfNew(data, 'waitlist', $event)"
                            class="btn default_btn_out"
                            v-else-if="
                                data.hasUser &&
                                    !data.isWaitlisted &&
                                    ...
                                    !data.originalHere &&
                                    !data.guestHere &&
                                    !data.schedule.studio.online_class
                            "
                        >
                            <span>Waitlist</span>
                        </div>
                        <div
                            class="btn default_btn_out disabled"
                            v-else-if="
                                data.hasUser &&
                                    data.isWaitlisted &&
                                    !data.schedule.studio.online_class
                        ...
                        <nuxt-link
                            :to="`/my-profile/manage-class/${data.id}`"
                            class="btn default_btn_out"
                            v-else-if="
                                data.hasUser &&
                                    (data.originalHere || data.guestHere)
                            "
                        >
                        ...
                        <div
                            class="btn default_btn_out"
                            @click="checkIfLoggedIn($event)"
                            v-else-if="!data.hasUser && !$store.state.isAuth"
                        >
                            <span>Book Now</span>
                        </div>
                    </div>
          ...
          <div class="overlay">
            ...
            <section id="comments">
                <div class="header">
                    <h2>
                        Here’s what other riders loved about
                        {{ res.first_name }}'s class
                    </h2>
                    <div class="btn">
                        <nuxt-link
                            :to="
                                `/instructors/${res.instructor_details.slug}/comment`
                            "
                            class="default_btn"
                        >
                            Write a Review
                        ...
                        <div class="star" v-for="n in 5">
                            <div :id="`star_${n}`" class="star_overlay">
                                ...
                                >
                                    ...
                                    <path
                                        class="a1"
                                        d="M1163.074,284.065l5.09,10.313,11.38,1.654-8.235,8.027,1.944,11.335-10.18-5.352-10.178,5.352,1.944-11.335-8.235-8.027,11.381-1.654Z"
                                        transform="translate(-1146.604 -284.065)"
                                    />
                                </svg>
                            </div>
                            <svg
                ...
                <div class="content" v-if="!$store.state.isMobile">
                    <div
                        class="comment"
                        v-for="(data, key) in populateComment"
                        :key="key"
                                ...
                                <div class="stats">
                                    ...
                                    <div class="stars">
                                        <img
                                            ...
                                            v-if="data.rating != 0"
                                            v-for="n in data.rating"
                                        />
                                        <img
                                            src="/icons/star-gray.svg"
                                            v-if="data.rating != 5"
                                            v-for="n in 5 - data.rating"
                                        />
                                    </div>
                                </div>
                                <div class="date">
                                    {{
                                        $moment(data.review_date).format(
                                            'MMMM D, YYYY'
                                        )
                                    }}
                                </div>
            ...
            <section id="ride_with">
                <div class="header">
                    ...
                    <a
                        :href="res.instructor_details.instagram"
                        target="_blank"
                        class="description"
                    >
                        <img
                            src="/icons/lets-ride-ig-icon.svg"
                            alt="lets-ride"
                        />
                        <span>
                            @{{ res.instructor_details.instagram_name }}
                        </span>
                    </a>
                </div>
                <div class="content">
            ...
            <section id="spotify">
                <div class="left">
                    ...
                    <div
                        v-html="res.instructor_details.spotify_description"
                    ></div>
                </div>
                <div
                    class="right"
                    v-html="res.instructor_details.spotify_embed"
                ></div>
            </section>
            <transition name="fade">
                <gallery
    ...
    export default {
        ...
        methods: {
            ...
            toggleOverlays(e) {
                const me = this
                let target = e.target
                let elements_first = document.querySelectorAll(
                    '#classes .description .limit .info_icon img'
                )
            ...
            async initial() {
                ...
                setTimeout(() => {
                            ...
                            if (me.rating != 0) {
                                if (!me.overallRatingComputed) {
                                    if (me.overallRating < i) {
                                        target.style.width = parseFloat(
                                            `${100 *
                                                `0.${
                                                    me.overallRating.split(
                                                        '.'
                                                    )[1]
                                                }`}%`
                                        )
                    ...
                    if ((token != null) & (token != undefined)) {
                        me.$axios
                            .get(
                                `api/web/instructors/${me.$route.params.slug}/scheduled-dates`,
                                {
                                    headers: {
                                        Authorization: `Bearer ${token}`
                                    }
                            ...
                            .then(res => {
                                res.data.scheduledDates.forEach(
                                    (schedule, index) => {
                    ...
                    me.$axios
                        .$get(
                            `https://stamped.io/api/widget/reviews?type=instagram-feed&apiKey=pubkey-b1f9lj3ib12svBob12UI0Z3a7lwNra&storeUrl=www.riderevolution.ph&isdataonly=true&productIds=${me.res.id}&take=100`
                        )
                        .then(({ data }) => {
                            data.sort(
                                (a, b) =>
                                    parseFloat(b.countLikes) -
                                    parseFloat(a.countLikes)
                            )
                            me.feeds = data
                        })
                    me.loader(false)
        ...
        asyncData({ $axios, params, error, store }) {
            return $axios
                .get(`api/web/instructors/${params.slug}`)
                .then(res => {
                    if (res.data) {
                        let tempRating = 0
                        let tempOverall = 0
                        let tempImages = []
                        res.data.instructor.instructor_details.gallery.forEach(
                            (data, index) => {
                                if (index != 0) {
                        ...
                        res.data.instructor.reviews.forEach(
                            (comment, index) => {
                        ...
                        if (tempRating != 0) {
                            tempOverall =
                                tempRating / res.data.instructor.reviews.length
                            tempOverall = tempOverall.toFixed(1)
                        }
                        return {
                            res: res.data.instructor,
                            mainImage:
                                res.data.instructor.instructor_details
                                    .gallery[0].path,
                ...
                meta: [
                    {
                        hid: 'og:title',
                        property: 'og:title',
                        content: `${me.res.instructor_details.meta_title}`
                    },
                    {
                        hid: 'og:description',
                        property: 'og:description',
                        content: `${me.res.instructor_details.meta_description}`
                    },
                    {
                        hid: 'og:keywords',
                        property: 'og:keywords',
                        content: `${me.res.instructor_details.meta_keywords}`
                    },
                    {
                        hid: 'og:url',
                        property: 'og:url',
                    ...
                    },
                    {
                        hid: 'og:image',
                        property: 'og:image',
                        content: `${me.res.instructor_details.gallery[0].path}`
                    },
                    {
                        hid: 'og:image:alt',
                        property: 'og:image:alt',
                        content: `${me.res.instructor_details.gallery[0].alt}`
                    },
