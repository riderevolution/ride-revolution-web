                        ...
                        <div class="wrapper studio_filter">
                            ...
                            <div class="group">
                                <input
                                    ...
                                    value="0"
                                    checked
                                    @change="toggleStudio(null, 'static')"
                                />
                            ...
                            >
                                <input
                                    ...
                                    name="studios"
                                    :id="`studio_${key + 1}`"
                                    @change="toggleStudio(studio, 'dynamic')"
                                />
                                <label :for="`studio_${key + 1}`">
                                    {{ studio.name }}
                                </label>
                            </div>
                        </div>
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        setTimeout(
                                                                            () => {
                                                                                ...
                                                                                // if (hasPackages) {
                                                                                me.$router.push(
                                                                                    `/fish-in-the-glass/book-a-bike/${data.id}?token=${token}`
                                                                                )
                                                                                /* } else {
                ...
                me.$axios
                    ...
                    .then(res => {
                        ...
                        if (me.res.dates.length > 0) {
                            ...
                            me.last_date =
                                me.res.dates[me.res.dates.length - 1].date
                        }
                        me.loaded = true
                    })
                    .catch(err => {
