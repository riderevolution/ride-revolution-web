        ...
        <div class="studios" v-if="loaded">
            ...
            <section id="visit">
                ...
                <div class="content desktop" v-if="!$store.state.isMobile">
                    <nuxt-link rel="canonical" :to="`/studios/${data.slug}`" class="wrapper" v-for="(data, key) in studios" :key="key" v-if="!data.online_class">
                        <div class="image">
                ...
                <div class="content" v-else>
                    <no-ssr>
                        <swiper :options="mobileOptions" class="default">
                            <swiper-slide class="wrapper" v-for="(data, key) in studios" :key="key" v-if="!data.online_class">
