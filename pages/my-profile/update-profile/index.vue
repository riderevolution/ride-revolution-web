                ...
                <div class="left">
                    ...
                    <ul class="side_menu">
                        <li
                            :class="
                                `side_menu_item ${
                                    category == data.unique ? 'active' : ''
                                }`
                            "
                            @click="toggledTab(key, data.unique)"
                        ...
                        .then(res => {
                            if (res.data) {
                                if (res.data.user.new_user == 1) {
                                    ...
                                    if (me.$route.hash) {
                                        me.category = me.$route.hash.split(
                                            '#'
                                        )[1]
                                    }
                                }
                                ...
                                setTimeout(() => {
                                    me.$refs.updateProfileTab.getHeight()
                                    me.$refs.updateProfileTab.ctr = 0
                                    me.$refs.updateProfileTab.unique =
                                        me.category == 'card' ? 2 : 0
                                }, 10)
                                me.loader(false)
                            }
                        })
