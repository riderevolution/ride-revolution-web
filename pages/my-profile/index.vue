                ...
                <div class="profile_tab">
                    <div class="top">
                        <div class="left">
                            <div class="overlay">
                                <img
                                    ...
                                    :src="
                                        `${
                                            user.customer_details.images[0]
                                                .path != null
                        ...
                        <div class="right">
                            ...
                            <div class="btn">
                                <div
                                    class="default_btn_wht"
                                    @click="viewImage(user.qr_url)"
                                >
                                    <span>QR Code</span>
                                </div>
                                <div
                                    class="default_btn_wht_out ml"
                                    @click="checkUser()"
                                >
                    ...
                    <div class="bottom">
                        ...
                        <div class="mobile" v-else>
                            <div class="tab_toggler toggled">
                                <div
                                    class="toggler"
                                    @click.self="toggleDetails($event)"
                                >
                                    {{ replacer(category) }}
                                </div>
            ...
            toggleTab(key, category) {
                ...
                switch (category) {
                            ...
                            .then(res => {
                                if (res.data) {
                                    ...
                                    for (
                                        ...
                                        series_data.push(
                                            res.data.customer.rideRevJourney
                                                .monthlyRideCount.series.data[i]
                                                .count
                                        )
                                        series_labels.push(
                                            me
                                    ...
                                    setTimeout(() => {
                                        ...
                                        me.$refs.profileTab.usertoNow = me
                                            .$moment(
                                                res.data.customer.created_at
                                            )
                                            .toNow()
                                        me.$refs.profileTab.tabChartCategory =
                                            'monthly'
                                    ...
                                    setTimeout(() => {
                                        ...
                                        res.data.customer.upcomingClasses.forEach(
                                            (data, index) => {
                                                data.toggled = false
                                                data.checked = false
                                                me.$refs.profileTab.classes.push(
                                                    data
                                                )
                                            }
                                        )
                                        ...
                                        res.data.customer.user_package_counts.forEach(
                                            (data, index) => {
                                                if (
                                                    ...
                                                    data.toggled = false
                                                    data.expired = false
                                                    me.$refs.profileTab.packages.push(
                                                        data
                                                    )
                                                    // }
                                                }
                    ...
                    case 'gift-cards':
                        ...
                        me.$axios
                            .get(
                                `api/customers/${me.user.id}/gift-cards?forWebBooking=1`
                            )
                            .then(res => {
                                if (res.data) {
                                    setTimeout(() => {
                                        me.$refs.profileTab.giftCards = []
                                        res.data.customer.giftCards.forEach(
                                            (data, index) => {
                                                me.$refs.profileTab.giftCards.push(
                                                    data
                                                )
                                            }
                                        )
                    ...
                    .then(res => {
                        if (res.data) {
                            if (res.data.user) {
                                ...
                                me.first_name = res.data.user.first_name.charAt(
                                    0
                                )
                            ...
                            if (
                                ...
                                me.$axios
                                    .get(
                                        `api/customers/${me.user.id}/ride-rev-journey`
                                    )
                                    .then(res => {
                                        if (res.data) {
                                            me.loaded = true
