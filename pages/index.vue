...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //     me.$axios
      //       .$get(
      //         `https://stamped.io/api/widget/reviews?type=instagram-feed&apiKey=pubkey-b1f9lj3ib12svBob12UI0Z3a7lwNra&storeUrl=www.riderevolution.ph&isdataonly=true&productIds=1001&take=100`
      //       )
      //       .then(({ data }) => {
      //         data.sort(
        ...
        meta: [
          {
            hid: 'og:title',
            property: 'og:title',
            content: `${me.above_the_fold.meta_title}`
          },
          {
            hid: 'og:description',
            property: 'og:description',
            content: `${me.above_the_fold.meta_description}`
          },
          {
            hid: 'og:keywords',
            property: 'og:keywords',
            content: `${me.above_the_fold.meta_keywords}`
          },
          {
            hid: 'og:url',
            property: 'og:url',
          ...
          },
          {
            hid: 'og:image',
            property: 'og:image',
            content: `${me.above_the_fold.banners[0].path}`
          },
          {
            hid: 'og:image:alt',
            property: 'og:image:alt',
            content: `${me.above_the_fold.banners[0].alt}`
          },
