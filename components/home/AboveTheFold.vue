<template lang="html">
    <section id="banner" :class="[ (!above_the_fold.show_overlay) ? 'no_overlay' : '' ]">
        ...
        <div class="overlay_mobile" v-if="$store.state.isMobile">
            ...
            <template v-if="above_the_fold.subtitle">
                <p class="nmr" v-html="above_the_fold.subtitle"></p>
            </template>
            <div :class="[ 'overlay_flex', (above_the_fold.subtitle) ? '' : 'center' ]">
        ...
        <div :class="[ 'overlay_bottom', (above_the_fold.subtitle) ? '' : 'center' ]" v-if="!$store.state.isMobile">
            <template v-if="above_the_fold.subtitle">
                <p class="nmr" v-html="above_the_fold.subtitle"></p>
            </template>
