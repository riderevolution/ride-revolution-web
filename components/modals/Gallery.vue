<template>
    <div :class="`gallery_modal ${(opened) ? 'opened' : ''} ${(toggled) ? 'toggled' : ''}`">
        <div class="main">
            <div class="overlay" v-if="$store.state.hiddenMobile">
            ...
            <div class="overlay mobile" v-else>
                <no-ssr v-if="!$store.state.hiddenMobile">
            ...
            <div class="controls">
                <button type="button" class="control_toggle" @click="toggler()" v-if="$store.state.hiddenMobile"></button>
                <button type="button" class="control_close" @click="close()"></button>
            </div>
        </div>
        <div class="thumb" v-if="$store.state.hiddenMobile">
            <div class="wrapper">
