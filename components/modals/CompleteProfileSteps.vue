        ...
        <section id="login" class="alt">
            ...
            >
                <div
                    id="default_form"
                    :class="
                        `${completeProfileStep == 1 ? 'fade_in' : 'fade_out'}`
                    "
                >
                    ...
                    <div class="form_group">
                        ...
                        <transition name="slide">
                            <span
                                ...
                                v-if="
                                    errors.has(
                                        'complete_profile_form.contact_number'
                                    )
                                "
                            >
                                {{
                    ...
                    <div class="form_group">
                        ...
                        <transition name="slide">
                            <span
                                ...
                                v-if="
                                    errors.has(
                                        'complete_profile_form.birth_date'
                                    )
                                "
                            >
                    ...
                    <div class="form_group select">
                        ...
                        <transition name="slide">
                            <span
                                ...
                                v-if="
                                    errors.has(
                                        'complete_profile_form.shoe_size'
                                    )
                                "
                            >
                                {{
                    ...
                    <div class="form_group select">
                        ...
                        <transition name="slide">
                            <span
                                ...
                                v-if="
                                    errors.has(
                                        'complete_profile_form.dumbbells'
                                    )
                                "
                            >
                                {{
                    ...
                    <div class="form_group weight">
                        ...
                        <div class="weight_input">
                            <input
                                ...
                                class="input_text"
                                v-validate="
                                    'required|numeric|min_value:1|max_value:200'
                                "
                            />
                            <transition name="slide">
                                <span
            ...
            >
                <div
                    id="default_form"
                    :class="
                        `${completeProfileStep == 2 ? 'fade_in' : 'fade_out'}`
                    "
                >
                    <div class="sign_up_header alt">
                            ...
                            <div class="form_group select">
                                ...
                                <div class="select">
                                    <select
                                        ...
                                        v-model="
                                            completeProfile.home_address_country
                                        "
                                        v-validate="'required'"
                                        @change="
                                            toggleWorld($event, 'state', 'pa')
                                        "
                                    >
                            ...
                            <div class="form_group select">
                                ...
                                <div class="select">
                                    <select
                                        ...
                                        v-model="
                                            completeProfile.home_address_state
                                        "
                                        v-validate="'required'"
                                    >
                                        <option value="0" selected disabled>
                        ...
                        <div class="form_flex">
                            ...
                            <div class="form_group">
                                ...
                                <input
                                    ...
                                    "
                                    v-model="
                                        completeProfile.home_address_zip_code
                                    "
            ...
            >
                <div
                    id="default_form"
                    :class="
                        `${completeProfileStep == 3 ? 'fade_in' : 'fade_out'}`
                    "
                >
                            ...
                            <div class="form_group select">
                                ...
                                <div class="select">
                                    <select
                                        ...
                                        v-model="
                                            completeProfile.billing_address_country
                                        "
                                        v-validate="'required'"
                                        @change="
                                            toggleWorld($event, 'state', 'ba')
                                        "
                                    >
                                        <option value="0" selected disabled>
                                            Choose a Country
                        ...
                        <div class="form_flex">
                            <div class="form_group">
                                ...
                                <input
                                    ...
                                    "
                                    v-model="
                                        completeProfile.billing_address_city
                                    "
                                    placeholder="Enter your city"
                                    v-validate="{
                                        required: true,
                            ...
                            <div class="form_group">
                                ...
                                <input
                                    ...
                                    "
                                    v-model="
                                        completeProfile.billing_address_zip_code
                                    "
                                    placeholder="Enter your zip code"
                                    v-validate="{
                                        required: true,
            ...
            >
                <div
                    id="default_form"
                    :class="
                        `${completeProfileStep == 4 ? 'fade_in' : 'fade_out'}`
                    "
                >
                    <div class="sign_up_header alt_2">
                        <h2 class="title">
...
<script>
    export default {
        ...
        methods: {
            inputDate(event) {
                const me = this
                me.completeProfile.birth_date = me.parseInputToDate(
                    event.target.value
                )
            },
            getSizes() {
            ...
            toggleStep(status) {
                ...
                switch (status) {
                    ...
                    case 'proceed':
                        if (me.completeProfileStep == 1) {
                            me.$validator
                                .validateAll('complete_profile_form')
                                .then(valid => {
                                    if (valid) {
                                        me.completeProfileStep = 2
                                    } else {
                    ...
                    case 'submit':
                        if (
                            me.completeProfile.medical_history.length ==
                            me.histories.length
                        ) {
                            me.error = false
                        } else {
                            ...
                            .then(valid => {
                                if (valid) {
                                    ...
                                    formData1.append(
                                        'medical_history',
                                        JSON.stringify(
                                            me.completeProfile.medical_history
                                        )
                                    )
                                    formData1.append(
                                        'email_waiver',
            ...
            me.$axios
                ...
                .then(res => {
                    if (res.data) {
                        ...
                        me.completeProfile.sex =
                            res.data.user.customer_details.co_sex
                        me.getSizes()
