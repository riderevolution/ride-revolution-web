                ...
                <div class="modal_wrapper">
                    ...
                    <div class="modal_main_group">
                        <div class="form_group">
                            ...
                            <input type="password" id="current_password" name="current_password" class="input_text" autocomplete="off" placeholder="Please enter your current password" v-validate="{required: true, regex: '^[a-zA-Z0-9_ |\u00f1|\@|\.|\#|\!|\$]*$'}" v-model="form.current_password">
                        ...
                        <div class="form_group">
                            ...
                            <input type="password" id="new_password" name="new_password" class="input_text" ref="new_password" autocomplete="off" placeholder="Please enter your new password" v-validate="{required: true, regex: '^[a-zA-Z0-9_ |\u00f1|\@|\.|\#|\!|\$]*$'}" v-model="form.new_password">
                        ...
                        <div class="form_group">
                            ...
                            <input type="password" id="verify_password" name="verify_password" class="input_text" autocomplete="off" placeholder="Please enter your verify password" v-validate="{required: true, confirmed: 'new_password', regex: '^[a-zA-Z0-9_ |\u00f1|\@|\.|\#|\!|\$]*$'}" v-model="form.verify_password">
