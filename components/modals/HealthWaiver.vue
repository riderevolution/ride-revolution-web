      ...
      <form id="step_4_form" data-vv-scope="complete_profile_4_form">
        <div id="default_form" class="fade_in">
          <div class="sign_up_header alt_2">
            <h2 class="title">Please sign our new health waiver.</h2>
          </div>
          ...
          <div class="form_main_group alt">
            ...
            <div class="form_group">
              ...
              <input
                ...
                v-model="user.customer_details.ec_contact_number"
              />
              <transition name="slide">
                <span
                  class="validation_errors"
  ...
  export default {
    ...
    methods: {
      ...
      toggleStep(status) {
        ...
        if (me.healthWaiver.medical_history.length == me.histories.length) {
          me.error = false
        } else {
          me.error = true
        }
        me.$validator.validateAll('complete_profile_4_form').then(valid => {
          if (valid) {
            ...
            let step4Form = new FormData(document.getElementById('step_4_form'))
            formData.append(
              'health_waiver',
