    ...
    <div class="default_modal alt">
        ...
        <div class="confirmation_wrapper">
            ...
            <div class="confirmation_text" v-if="type == 1">
                ...
                {{ user_package_count.class_package.name }} subscription?
            </div>
            <div class="form_group mt" v-if="type == 1">
                ...
                <transition name="slide">
                    <span class="validation_errors" v-if="errors.has('reason')">
                        {{ properFormat(errors.first('reason')) }}
                    </span>
                </transition>
            </div>
            <div class="confirmation_text" v-if="type != 1">
