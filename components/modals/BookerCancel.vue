    ...
    <div class="default_modal alt">
        ...
        <div class="confirmation_wrapper">
            ...
            <div class="confirmation_text" v-else>
                Your booking has been cancelled. An email notification will also
                        ...
                        me.$axios
                            ...
                            .then(res => {
                                if (res.data) {
                                    ...
                                    formData.append(
                                        'scheduled_date_id',
                                        me.seat.bookings[0].scheduled_date_id
                                    )
                                    ...
                                    me.$axios
                                        ...
                                        .then(res => {
                                            if (res.data) {
                                                if (
                                                    me.$parent.schedule.schedule
                                                        .studio.online_class
                                                ) {
                                                    me.seat.bookings.forEach(
                                                        (booking, key) => {
                                                            if (
                                                                user.user.id ==
                                                                booking.user_id
