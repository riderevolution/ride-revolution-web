    ...
    <div class="default_modal overlay alt">
        ...
        <div class="confirmation_wrapper">
            <div class="confirmation_text">
                {{ ($route.name == 'my-profile-manage-class-slug') ? `Are you sure you want to cancel seat number ${seat.number}? This action cannot be undone.` : `Are you sure you want to cancel seat number ${seat.number}?` }}
            </div>
