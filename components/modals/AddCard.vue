        ...
        <div class="background" @click="toggleClose()"></div>
            <form id="default_form" class="overlay alt_2" @submit.prevent="submissionSuccess()">
                <div class="modal_wrapper">
                    ...
                    <h3 class="form_subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</h3>
                    <div class="form_close" @click="toggleClose()"></div>
                    <div class="modal_main_group">
                        <div class="form_flex">
							<div class="form_group">
								<label for="number">Card Number <span>*</span></label>
								<input type="text" id="number" class="input_text" placeholder="4111111111111111" value="4012 0010 3714 1112" name="card_number" v-validate="{ required: true, credit_card: true }">
							...
							<div class="form_group">
								<div class="form_flex three">
									<div class="form_group">
										...
										<input type="text" id="month" class="input_text" placeholder="03" value="12" name="card_month" v-validate="{ required: true, date_format: 'MM' }">
									...
									<div class="form_group">
										...
										<input type="text" id="cvv" class="input_text" placeholder="123" value="212" name="card_cvv" v-validate="{ required: true, numeric: true, min: 3, max: 3 }">
