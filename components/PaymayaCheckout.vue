    ...
    <div class="buy_rides inner" v-if="loaded">
        <div class="comment alt">
            <section id="content">
                <div class="bck">
                    <div
                        @click.once="$parent.proceedToPayment('paynow')"
                        class="default_btn_blk alt"
                    >
                        <img src="/icons/back-arrow-icon.svg" />
                        <span>Go Back</span>
                    </div>
                </div>
                <form
                    ...
                    <div class="form_main_group">
                        ...
                        <div class="form_group_disclaimer">
                            <div class="form_disclaimer">
                                ...
                                <span>
                                    Upon saving, this will also update your
                                    information/details.
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form_group">
                            ...
                            <input
                                ...
                                autocomplete="off"
                                v-model="
                                    user.customer_details.co_contact_number
                                "
                        ...
                        <div class="form_flex radio">
                            ...
                            <div class="form_radio">
                                <input
                                    ...
                                    class="input_radio"
                                    v-validate="'required'"
                                    v-model="user.customer_details.co_sex"
                                />
                        ...
                        <div class="form_flex">
                            <div class="form_custom_checkbox">
                                <div
                                    ...
                                    :class="{ active: data.toggled }"
                                    v-for="(data, key) in cards"
                                    :key="key"
                                    @click="toggleCard(data, key)"
                                >
                                    <div
                                        class="c_type"
                                        v-html="cardType(data)"
                                    ></div>
                                    <label>
                                        **** **** **** {{ data.last4 }}
                                    </label>
                    ...
                    <div class="form_main_group">
                        ...
                        <div class="form_flex">
                            <div class="form_group">
                                ...
                                <transition name="slide">
                                    <span
                                        class="validation_errors"
                                        v-if="errors.has('billing_first_name')"
                                    >
                                        {{
                                            properFormat(
                                                errors.first(
                            ...
                            <div class="form_group">
                                ...
                                <transition name="slide">
                                    <span
                                        class="validation_errors"
                                        v-if="errors.has('billing_last_name')"
                                    >
                                        {{
                                            properFormat(
                                                errors.first(
                        ...
                        <div class="form_group">
                            ...
                            <transition name="slide">
                                ...
                                >
                                    {{ properFormat(errors.first('phone')) }}
                                </span>
                            </transition>
                        </div>
                        <div class="form_group">
                            ...
                            <input
                                ...
                                class="input_text"
                                v-validate="{ required: true }"
                                v-model="user.customer_details.ba_address"
                            />
                            <transition name="slide">
                                <span
                                    class="validation_errors"
                                    v-if="errors.has('billing_address_1')"
                                >
                                    {{
                                        properFormat(
                        ...
                        <div class="form_group">
                            ...
                            <input
                                ...
                                class="input_text"
                                v-model="user.customer_details.ba_address_2"
                            />
                        </div>
                        <div class="form_flex">
                            ...
                            <div class="form_group select">
                                ...
                                <input
                                    ...
                                    name="state"
                                    v-model="
                                        user.customer_details.billing_state
                                    "
                                ...
                                <transition name="slide">
                                    ...
                                    >
                                        {{
                                            properFormat(errors.first('state'))
                                        }}
                                    </span>
                                </transition>
                            </div>
                        ...
                        <div class="form_flex">
                            <div class="form_group">
                                ...
                                <input
                                    ...
                                    class="input_text"
                                    name="city"
                                    v-model="user.customer_details.ba_city"
                                ...
                                <transition name="slide">
                                    ...
                                    >
                                        {{ properFormat(errors.first('city')) }}
                                    </span>
                                </transition>
                            </div>
                            <div class="form_group">
                                ...
                                <input
                                    ...
                                    autocomplete="off"
                                    class="input_text"
                                    v-model="user.customer_details.ba_zip_code"
        ...
        methods: {
                            ...
                            .then(verify => {
                                if (verify) {
                                    ...
                                    me.payment(
                                        ...
                                        null,
                                        me.type,
                                        me.selected_card.cardTokenId,
                                        paymaya_extra_user_details
                                    )
                                }
                            })
                            .catch(err => {
            ...
            getCards() {
                ...
                me.$axios
                    ...
                    .then(res => {
                        for (
                            let i = 0, len = res.data.cards.length;
                            i < len;
                            i++
                        ) {
